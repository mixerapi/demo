...
<footer id="footer">
    <section>
        ...
        <ul class="actions">
            <li>
                <a href="https://mixerapi.com" class="button">
                    Learn More
                </a>
            </li>
        </ul>
    ...
    <section>
        ...
        <ul class="icons">
            ...
            <li>
                <a href="https://twitter.com/mixerapi" class="icon brands fa-twitter alt">
                    <span class="label">Twitter</span>
                </a>
            </li>
            <li>
                <a href="https://cakesf.slack.com" class="icon brands fa-slack alt">
                    <span class="label">Slack</span>
                </a>
            </li>
        </ul>
    </section>
    <p class="copyright">&copy; <a href="https://mixerapi.com">MixerAPI</a></p>
</footer>
